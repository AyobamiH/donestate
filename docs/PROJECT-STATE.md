...
- **Content:** Development-only Worker and state, OAuth App and draft listing identities, credential names, zero-cost Development Test plan, route allowlist, signed ping and purchase deliveries, publisher-reported cancellation, and explicit remaining proof gaps; no secret values or personal billing data.
