...
Marketplace submission remains blocked only on completing the contact record, replacing preview-only legal language with the operator's binding terms, and the human owner's final review declaration.replaces preview-only legal language, and the human owner accepts GitHub's Marketplace Developer Agreement and final review declaration.
